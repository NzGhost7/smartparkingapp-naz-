//Home Page but for user who skipp the login page
...
class SearchPark extends StatefulWidget {
  const SearchPark({super.key});

  @override
  State<SearchPark> createState() => _SearchParkState();
}

class _SearchParkState extends State<SearchPark> {
          ...
          DrawerHeader(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('images/Flexible Self-Adhesive Paved Parking Lot -- 7-7_8 x 6-3_16_  20 x 16cm.jpg'),
                fit: BoxFit.cover
              ),
            ),
          ),
          ...
          children: <Widget>[
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    setState(() {
                      _searchResults = _allPark
                          .where((park) =>
                              park.name.toLowerCase().contains(_searchLocation.text.toLowerCase()) ||
                              park.address.toLowerCase().contains(_searchLocation.text.toLowerCase()))
                          .toList();
                    });
                  },
                  child: Icon(
            ...
            Expanded(
              ...
              itemBuilder: (context, index) {
                return Card(
                  child: ListTile(
                    title: Text(_searchResults[index].name, style: TextStyle(fontWeight: FontWeight.bold),),
